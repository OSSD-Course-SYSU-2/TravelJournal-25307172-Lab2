...
export const PROVINCE_ELLIPSES: Province[] = [
    // ===== 西北 =====
    { id: 'xinjiang', name: '新疆', cx: 249, cy: 310, rx: 155, ry: 125, color: '#C2A67A', isLighted: false, memories: [] },
    { id: 'xizang', name: '西藏', cx: 257, cy: 710, rx: 130, ry: 105, color: '#E5E0D5', isLighted: false, memories: [] },
    { id: 'qinghai', name: '青海', cx: 430, cy: 475, rx: 95, ry: 76, color: '#5B7C8C', isLighted: false, memories: [] },
    { id: 'gansu', name: '甘肃', cx: 575, cy: 380, rx: 78, ry: 55, color: '#B5756A', isLighted: false, memories: [] },
    { id: 'ningxia', name: '宁夏', cx: 760, cy: 340, rx: 40, ry: 34, color: '#A55D52', isLighted: false, memories: [] },
    { id: 'shaanxi', name: '陕西', cx: 677, cy: 525, rx: 62, ry: 55, color: '#AD8B72', isLighted: false, memories: [] },
    // ===== 华北 =====
    { id: 'neimenggu', name: '内蒙古', cx: 807, cy: 210, rx: 118, ry: 82, color: '#A3B6A5', isLighted: false, memories: [] },
    { id: 'shanxi', name: '山西', cx: 780, cy: 445, rx: 48, ry: 55, color: '#A29B8F', isLighted: false, memories: [] },
    { id: 'hebei', name: '河北', cx: 967, cy: 425, rx: 55, ry: 48, color: '#D1C7B7', isLighted: false, memories: [] },
    { id: 'beijing', name: '北京', cx: 1017, cy: 340, rx: 38, ry: 32, color: '#B28B84', isLighted: false, memories: [] },
    { id: 'tianjin', name: '天津', cx: 1157, cy: 355, rx: 38, ry: 32, color: '#7F8C8D', isLighted: false, memories: [] },
    // ===== 东北 =====
    { id: 'liaoning', name: '辽宁', cx: 1317, cy: 385, rx: 52, ry: 48, color: '#5B7B8A', isLighted: false, memories: [] },
    { id: 'jilin', name: '吉林', cx: 1452, cy: 270, rx: 55, ry: 50, color: '#B7A9B8', isLighted: false, memories: [] },
    { id: 'heilongjiang', name: '黑龙江', cx: 1457, cy: 140, rx: 76, ry: 62, color: '#C0C5C1', isLighted: false, memories: [] },
    // ===== 华东 =====
    { id: 'shandong', name: '山东', cx: 1187, cy: 460, rx: 52, ry: 48, color: '#A57C6B', isLighted: false, memories: [] },
    { id: 'jiangsu', name: '江苏', cx: 1267, cy: 545, rx: 46, ry: 42, color: '#A7B8A4', isLighted: false, memories: [] },
    { id: 'shanghai', name: '上海', cx: 1407, cy: 575, rx: 36, ry: 32, color: '#D4B5B0', isLighted: false, memories: [] },
    { id: 'anhui', name: '安徽', cx: 1317, cy: 637, rx: 46, ry: 42, color: '#E2DCD3', isLighted: false, memories: [] },
    { id: 'zhejiang', name: '浙江', cx: 1437, cy: 685, rx: 48, ry: 45, color: '#B8B5B0', isLighted: false, memories: [] },
    { id: 'jiangxi', name: '江西', cx: 1207, cy: 705, rx: 50, ry: 45, color: '#6F7F8F', isLighted: false, memories: [] },
    { id: 'fujian', name: '福建', cx: 1297, cy: 775, rx: 42, ry: 40, color: '#B59A8A', isLighted: false, memories: [] },
    { id: 'taiwan', name: '台湾', cx: 1517, cy: 765, rx: 36, ry: 45, color: '#AAB5B8', isLighted: false, memories: [] },
    // ===== 华中 =====
    { id: 'henan', name: '河南', cx: 990, cy: 533, rx: 50, ry: 46, color: '#C2B29A', isLighted: false, memories: [] },
    { id: 'hubei', name: '湖北', cx: 1000, cy: 645, rx: 52, ry: 48, color: '#89A094', isLighted: false, memories: [] },
    { id: 'hunan', name: '湖南', cx: 970, cy: 755, rx: 55, ry: 50, color: '#B56A5C', isLighted: false, memories: [] },
    // ===== 西南 =====
    { id: 'sichuan', name: '四川', cx: 590, cy: 680, rx: 74, ry: 62, color: '#8DA38A', isLighted: false, memories: [] },
    { id: 'chongqing', name: '重庆', cx: 840, cy: 610, rx: 45, ry: 40, color: '#9E5E54', isLighted: false, memories: [] },
    { id: 'guizhou', name: '贵州', cx: 800, cy: 708, rx: 50, ry: 45, color: '#5B6F7A', isLighted: false, memories: [] },
    { id: 'yunnan', name: '云南', cx: 537, cy: 800, rx: 66, ry: 55, color: '#BDB2A4', isLighted: false, memories: [] },
    // ===== 华南 =====
    { id: 'guangdong', name: '广东', cx: 1147, cy: 815, rx: 50, ry: 46, color: '#D4C9B8', isLighted: false, memories: [] },
    { id: 'guangxi', name: '广西', cx: 880, cy: 845, rx: 58, ry: 50, color: '#7A9A8E', isLighted: false, memories: [] },
    { id: 'hainan', name: '海南', cx: 1017, cy: 935, rx: 36, ry: 32, color: '#D6A9A2', isLighted: false, memories: [] },
    { id: 'xianggang', name: '香港', cx: 1312, cy: 855, rx: 34, ry: 30, color: '#7C8B8F', isLighted: false, memories: [] },
