...
namespace OHOS {
const int32_t STRING_ABILITY_DESC = 0x01000001;
const int32_t STRING_ABILITY_LABEL = 0x01000002;
const int32_t STRING_APP_NAME = 0x01000000;
const int32_t STRING_DISTRIBUTED_REASON = 0x01000003;
const int32_t STRING_MODULE_DESC = 0x01000004;
const int32_t COLOR_START_WINDOW_BACKGROUND = 0x01000005;
const int32_t MEDIA_APP_ICON = 0x01000006;
